  ...
  return (
    ...
    >
      <Container>
        ...
        >
          ...
          <Stack spacing={3} align="center" textAlign="center">
            ...
            <HStack spacing={4} justify="center">
              <Link as={NextLink} href="/menu" color="link.footer">
                Carte
              </Link>
              <Link as={NextLink} href="/entreprises" color="link.footer">
                Entreprises
              </Link>
              <Link as={NextLink} href="/reservation" color="link.footer">
                Réservation
              </Link>
            </HStack>
          </Stack>
        ...
        >
          <Text fontSize="sm">
            © {new Date().getFullYear()} {fullName}. Tous droits réservés.
          </Text>
          <HStack spacing={4} fontSize="sm">
            <Link as={NextLink} href="/mentions-legales" color="link.footer">
              Mentions légales
            </Link>
            <Link
              as={NextLink}
